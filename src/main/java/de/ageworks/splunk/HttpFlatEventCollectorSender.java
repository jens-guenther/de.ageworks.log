...
final class HttpFlatEventCollectorSender extends TimerTask implements HttpEventCollectorMiddleware.IHttpSender {
     ...
     */
    public HttpFlatEventCollectorSender(
    ...
    public synchronized void send(
        ...
        HttpEventCollectorEventInfo eventInfo =
                new HttpFlatEventCollectorEventInfo(time, severity, message, logger_name, thread_name, properties, exception_message, marker);
